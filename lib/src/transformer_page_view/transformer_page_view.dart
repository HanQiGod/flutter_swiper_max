...
export 'package:flutter_swiper_max/src/transformer_page_view/index_controller.dart';
export 'package:flutter_swiper_max/src/transformer_page_view/parallax.dart';
