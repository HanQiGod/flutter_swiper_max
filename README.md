...
<p align="center">
    <a href="https://github.com/mimajiushi/flutter_swiper_max/blob/master/README-ZH.md">
        <b>中文说明</b>
    </a>
</p>
...
- You can override 'PageTransformer' to customize the animation, see[`buildin_transformers.dart`](https://github.com/mimajiushi/flutter_swiper_max/blob/master/lib/src/transformer_page_view/buildin_transformers.dart)
...
> you can run [`main.dart`](https://github.com/mimajiushi/flutter_swiper_max/blob/master/example/lib/main.dart)in example to see the actual effect.
...
- See：[CHANGELOG.md](https://github.com/mimajiushi/flutter_swiper_max/blob/master/CHANGELOG.md)
